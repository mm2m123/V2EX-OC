...
+ (ZDTostView *)errorMessageView:(NSString *)aMessage
{
    ...
    UIImage *image = [UIImage imageNamed:@"tost_warning" inBundle:bundle compatibleWithTraitCollection:nil];
...
+ (ZDTostView *)succeedMessageView:(NSString *)aMessage
{
    ...
    UIImage *image = [UIImage imageNamed:@"tost_succeed" inBundle:bundle compatibleWithTraitCollection:nil];
...
+ (ZDTostView *)netErrorView:(NSString *)aMessage
{
    ...
    UIImage *image = [UIImage imageNamed:@"tost_netError" inBundle:bundle compatibleWithTraitCollection:nil];
